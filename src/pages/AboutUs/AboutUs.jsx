  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 ">
      ...
      <section className="text-center mb-20 ">
        <h1 className="text-5xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">
          About WhereIsIt
        </h1>
      ...
      <section className="grid md:grid-cols-2 gap-8 mb-20 fade-in">
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-teal-50">
          <div className="flex items-center mb-4">
            <FaBullseye className="text-3xl text-teal-600 mr-3" />
        ...
        <div className="bg-teal-900 rounded-2xl p-8 shadow-lg text-white">
          <div className="flex items-center mb-4">
            <FaHandshake className="text-3xl text-teal-300 mr-3" />
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={index} className="p-4 bg-white bg-opacity-10 rounded-xl">
                ...
                <p className="opacity-90">{value.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white rounded-2xl shadow-xl p-10 fade-in">
        <div className="text-center">
          <FaEnvelope className="text-4xl text-teal-600 mx-auto mb-4" />
          <h2 className="text-4xl font-bold mb-4 text-gray-800">Need Help?</h2>
          <p className="text-xl text-gray-600 mb-6">Our support team is here 24/7</p>
          <a href="mailto:support@whereisit.com" className="inline-block bg-teal-600 text-white px-8 py-3 rounded-full hover:bg-teal-700 transition-colors text-lg font-medium shadow-lg hover:shadow-teal-200">
            Contact Us Now
          </a>
        </div>
      </section>
